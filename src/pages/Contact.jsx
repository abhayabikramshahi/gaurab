...
<body class="bg-black flex items-center justify-center min-h-screen p-4">
  <div class="text-center max-w-lg">
    ...
    <h2 class="text-2xl font-semibold mt-2 text-white">Access Forbidden</h2>
    <p class="mt-4 text-white">🚫 Sorry! You don’t have permission to view this contact page.</p>
    <p class="mt-2 text-sm text-white">This might be due to admin restrictions or missing credentials.</p>
